    ...
    <main className="p-4 sm:p-6 lg:p-8">
      <div className="space-y-6">
        ...
        <header className="fade-up fade-up-1 space-y-3">
          ...
          {/* <h1 className="font-serif text-[clamp(1.75rem,3.5vw,2.5rem)] font-bold leading-tight text-[color:var(--color-dark)]">
            {greeting}
          </h1> */}
        ...
        <AdminCard>
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h2 className="font-serif text-2xl font-bold text-[color:var(--color-dark)]">My Forms</h2>
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 rounded-[10px] border-2 border-black bg-[color:var(--color-saffron)] px-4 py-3 text-sm font-bold text-white shadow-[3px_3px_0_0_#000] transition-all hover:-translate-y-px hover:shadow-[4px_4px_0_0_#000] active:translate-y-0 active:shadow-none"
            >
          ...
          <div className="mt-5 space-y-4">
            {forms.length === 0 ? (
              <div className="flex flex-col items-center gap-3 rounded-[16px] border-2 border-dashed border-black/20 py-12 text-center">
                ...
                <p className="font-serif text-lg font-bold text-[color:var(--color-dark)]">No forms yet</p>
                <p className="text-sm font-semibold text-muted-foreground">Create your first initiative to get started.</p>
              </div>
            ) : (
