          ...
          <div className="space-y-6 p-6 text-center sm:p-8">
            ...
            <div className="flex flex-col gap-3 pt-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex w-full items-center justify-center gap-2.5 rounded-[10px] border-2 border-black bg-[#25D366] px-4 py-3.5 text-sm font-bold text-white shadow-[3px_3px_0_0_#000] transition-all hover:-translate-y-px hover:shadow-[4px_4px_0_0_#000] active:translate-y-0 active:shadow-none hover:bg-[#1fb355]"
              >
