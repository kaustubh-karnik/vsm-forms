  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-10 sm:px-6">
      ...
      <div className="mx-auto w-full max-w-[520px]">
        <article className="overflow-hidden rounded-[28px] border border-[color:var(--color-border)] bg-[color:var(--color-card)] shadow-warm">
          ...
          <div className="space-y-6 p-6 text-center sm:p-8">
            <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-[color:var(--color-saffron)] shadow-[0_4px_24px_rgba(232,100,10,0.4)]">
            ...
            <div className="flex flex-col gap-3 pt-2">
              <a
                ...
                className="inline-flex w-full items-center justify-center gap-2.5 rounded-[12px] bg-[#25D366] px-4 py-3.5 text-sm font-semibold text-white shadow-warm transition-all hover:-translate-y-[1px] hover:bg-[#1fb355] hover:shadow-[0_6px_20px_rgba(37,211,102,0.35)]"
              >
              ...
              <Link
                href="/"
                className="inline-flex w-full items-center justify-center rounded-[12px] border border-[color:var(--color-border)] bg-white px-4 py-3 text-sm font-semibold text-[color:var(--color-muted)] transition-all hover:border-[color:rgba(232,100,10,0.22)] hover:text-[color:var(--color-saffron)]"
              >
